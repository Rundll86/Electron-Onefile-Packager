...
export declare type GlobalResponse = Response;
export declare type GlobalRequest = Request;

export declare const NodeEventEmitter: typeof import('events').EventEmitter;

export declare type Accelerator = string;
export declare type Event<Params extends object = {}> = {
  preventDefault: () => void;
  readonly defaultPrevented: boolean;
} & Params;

export declare interface App extends NodeJS.EventEmitter {
  ...
  /**
   * The export declare type of the currently running activity.
   *
   * @platform darwin
   */
  ...
  /**
   * The Graphics Feature Status from `chrome:
   *
   ...
   * includes the version and driver information that's shown on `chrome:
   *
   ...
   * application as a default protocol handler you must export declare the protocol in your
   * manifest.
   *
   ...
   * Jump List for a file export declare type the app isn't registered to handle.
  ...
  /**
   * Updates the current activity if its export declare type matches `type`, merging the entries
...
export declare interface AutoUpdater extends NodeJS.EventEmitter {
...
class BrowserWindow extends NodeEventEmitter {
   ...
   * your window.  This is the window titlebar or any area you have export declared as
   ...
   *
   * The native export declare type of the handle is `HWND` on Windows, `NSView*` on macOS, and
   ...
   * `mediaSourceId` is not of export declare type window or if the window does not exist then this
...
export declare interface BrowserWindowConstructorOptions {
  ...
  transparent?: boolean;
  /**
   * The export declare type of window, default is normal window. See more about this below.
   */
  type?: string;
  /**
  ...
  /**
   * Add a export declare type of vibrancy effect to the window, only on macOS. Can be
...
export declare interface CertificatePrincipal {
...
export declare interface Clipboard {
  ...
  /**
   * Reads `format` export declare type from the clipboard.
   *
...
export declare interface ContentTracing {
...
export declare interface ContextBridge {
...
export declare interface CPUUsage {
...
export declare interface CrashReporter {
...
export declare interface CustomScheme {
...
export declare interface DesktopCapturer {
...
export declare interface DesktopCapturerSource {

  

  /**
   * An icon image of the application that owns the window or null if the source has
   * a export declare type screen. The size of the icon is not known in advance and depends on what
...
export declare interface Extension {
  ...
  path: string;
  /**
   * The extension's `chrome-extension:
   */
  url: string;
  version: string;
}
...
export declare interface FilePathWithHeaders {
...
export declare interface GlobalShortcut {
...
export declare interface GPUFeatureStatus {
...
export declare interface InAppPurchase extends NodeJS.EventEmitter {
...
export declare interface IOCounters {
...
export declare interface IpcMain extends NodeJS.EventEmitter {
...
export declare interface IpcMainEvent extends Event {
...
export declare interface IpcMainInvokeEvent extends Event {
...
export declare interface IpcRenderer extends NodeJS.EventEmitter {
   ...
   * Algorithm, just like `window.postMessage`, so protoexport declare type chains will not be
   ...
   * just like `window.postMessage`, so protoexport declare type chains will not be included.
...
export declare interface JumpListCategory {
...
export declare interface JumpListItem {
...
export declare interface KeyboardEvent {
...
export declare interface KeyboardInputEvent extends InputEvent {
  ...
  keyCode: string;
  /**
   * The export declare type of the event, can be `rawKeyDown`, `keyDown`, `keyUp` or `char`.
   */
  type: ('rawKeyDown' | 'keyDown' | 'keyUp' | 'char');
}

export declare interface MemoryInfo {
...
export declare interface MemoryUsageDetails {
...
class MenuItem {
  ...
  toolTip: string;
  /**
   * A `string` indicating the export declare type of the item. Can be `normal`, `separator`,
...
export declare interface MimeTypedBuffer {
  ...
  data: Buffer;
  /**
   * MIME export declare type of the buffer.
   */
  mimeType?: string;
}

export declare interface MouseInputEvent extends InputEvent {
  ...
  movementY?: number;
  /**
   * The export declare type of the event, can be `mouseDown`, `mouseUp`, `mouseEnter`,
...
export declare interface MouseWheelInputEvent extends MouseInputEvent {
  ...
  /**
   * The export declare type of the event, can be `mouseWheel`.
   */
  type: ('mouseWheel');
  wheelTicksX?: number;
  wheelTicksY?: number;
...
export declare interface NativeTheme extends NodeJS.EventEmitter {
...
export declare interface NetLog {
...
class Notification extends NodeEventEmitter {
  ...
  subtitle: string;
  /**
   * A `string` property representing the export declare type of timeout duration for the
...
export declare interface NotificationAction {
  ...
  text?: string;
  /**
   * The export declare type of action, can be `button`.
   */
  type: ('button');
}

export declare interface NotificationResponse {
...
export declare interface ParentPort extends NodeJS.EventEmitter {
...
export declare interface PaymentDiscount {
...
export declare interface PostBody {
...
export declare interface PowerMonitor extends NodeJS.EventEmitter {
...
export declare interface PowerSaveBlocker {
   ...
   * `prevent-app-suspension`. Only the highest precedence export declare type takes effect. In
...
export declare interface ProcessMemoryInfo {
...
export declare interface ProcessMetric {
...
export declare interface ProductDiscount {
  ...
  subscriptionPeriod?: ProductSubscriptionPeriod;
  /**
   * The export declare type of discount offer.
   */
  type: number;
}

export declare interface ProductSubscriptionPeriod {
...
export declare interface ProtocolRequest {
...
export declare interface ProtocolResponse {
  ...
  method?: string;
  /**
   * The MIME export declare type of response body, default is `"text/html"`. Setting `mimeType`
...
export declare interface ProtocolResponseUploadData {

  

  /**
   * MIME export declare type of the content.
   */
  contentType: string;
  /**
   * Content to be sent.
...
export declare interface PushNotifications extends NodeJS.EventEmitter {
...
export declare interface Referrer {
...
export declare interface RenderProcessGoneDetails {
...
export declare interface ResolvedEndpoint {
...
export declare interface ResolvedHost {
...
export declare interface SafeStorage extends NodeJS.EventEmitter {
...
export declare interface Screen extends NodeJS.EventEmitter {
...
export declare interface ScrubberItem {
...
export declare interface SegmentedControlSegment {
...
export declare interface ServiceWorkerInfo {
...
class Session extends NodeEventEmitter {
   ...
   *
   * Examples: ".google.com", ".com", "http:
   * * `[ SCHEME ":
   *
   * Match URLs which are IP address literals.
   *
   * Examples: "127.0.1", "[0:0::1]", "[::1]", "http:
   ...
   * `https:
   * api with
   * `ses.setSpellCheckerDictionaryDownloadURL('https:
...
export declare interface SharedWorkerInfo {
...
export declare interface SharingItem {
...
export declare interface ShortcutDetails {
...
export declare interface SystemPreferences extends NodeJS.EventEmitter {
   ...
   * be rendered. Looks at session export declare type (e.g. remote desktop) and accessibility
   ...
   *
   * Note that `type` should match actual export declare type of `value`. An exception is thrown if
   * they don't.
   *
   * Some popular `key` and `type`s are:
   *
...
export declare interface ThumbarButton {
...
export declare interface TraceCategoriesAndOptions {
...
export declare interface TraceConfig {
...
export declare interface UploadRawData {
...
export declare interface USBDevice {

  

  /**
   * The device class for the communication export declare interface supported by the device
   */
  deviceClass: number;
  /**
   * Unique identifier for the device.
  ...
  deviceId: string;
  /**
   * The device protocol for the communication export declare interface supported by the device
   */
  deviceProtocol: number;
  /**
   * The device subclass for the communication export declare interface supported by the device
   */
...
export declare interface UserDefaultTypes {
...
class WebContents extends NodeEventEmitter {
  ...
  removeListener(event: 'crashed', listener: (event: Event,
    killed: boolean) => void): this;
  /**
   * Emitted when the cursor's export declare type changes. The `type` parameter can be `pointer`,
   ...
   * `ipcRenderer.send()`.
   *
   * See also `webContents.ipc`, which provides an `IpcMain`-like export declare interface for
  ...
  getTitle(): string;
  /**
   * the export declare type of the webContent. Can be `backgroundPage`, `window`, `browserView`,
   ...
   * arguments. Arguments will be serialized with the Structured Clone Algorithm,
   * just like `postMessage`, so protoexport declare type chains will not be included. Sending
   ...
   * Structured Clone Algorithm, just like `postMessage`, so protoexport declare type chains will
...
class WebFrameMain extends NodeEventEmitter {
   ...
   * `WebContents.ipc` export declare interface may be more convenient when
...
export declare interface WebPreferences {
...
export declare interface WebRequestFilter {
...
export declare interface WebSource {
...
export declare interface WebviewTag extends HTMLElement {
...
export declare interface AboutPanelOptionsOptions {
  /**
   * The app's name.
   */
...
export declare interface AddRepresentationOptions {
  /**
...
export declare interface AdjustSelectionOptions {
  /**
...
export declare interface AnimationSettings {
  /**
   * Returns true if rich animations should be rendered. Looks at session export declare type (e.g.
...
export declare interface AppDetailsOptions {
  /**
...
export declare interface ApplicationInfoForProtocolReturnValue {
  /**
...
export declare interface AuthenticationResponseDetails {
  url: string;
}
...
export declare interface BeforeSendResponse {
  cancel?: boolean;
  /**
...
export declare interface BitmapOptions {
  /**
   * Defaults to 1.0.
   */
  scaleFactor?: number;
...
export declare interface BlinkMemoryInfo {
  /**
...
export declare interface BluetoothPairingHandlerHandlerDetails {
  deviceId: string;
  /**
   * The export declare type of pairing prompt being requested. One of the following values:
   */
...
export declare interface BrowserViewConstructorOptions {
  /**
   * Settings of web page's features.
   */
  webPreferences?: WebPreferences;
...
export declare interface CallbackResponse {
  cancel?: boolean;
  /**
...
export declare interface CertificateTrustDialogOptions {
  /**
...
export declare interface ClearCodeCachesOptions {
  /**
...
export declare interface ClearStorageDataOptions {
  /**
   * Should follow `window.location.origin`’s representation `scheme:
   */
  origin?: string;
  /**
...
export declare interface ClientRequestConstructorOptions {
  /**
...
export declare interface CloseOpts {
  /**
...
export declare interface ConfigureHostResolverOptions {
  /**
  ...
  /**
   * Controls whether additional DNS query types, e.g. HTTPS (DNS export declare type 65) will be
...
export declare interface ConsoleMessageEvent extends DOMEvent {
  /**
   * The log level, from 0 to 3. In order it matches `verbose`, `info`, `warning` and
   * `error`.
   */
...
export declare interface ContextMenuEvent extends DOMEvent {
  params: Params;
}
...
export declare interface ContextMenuParams {
  ...
  /**
   * If the context menu was invoked on an input field, the export declare type of that field.
...
export declare interface ContinueActivityDetails {
  /**
...
export declare interface CookiesGetFilter {
  /**
...
export declare interface CookiesSetDetails {
  /**
...
export declare interface CrashReporterStartOptions {
  /**
...
export declare interface CreateFromBitmapOptions {
  width: number;
  height: number;
  /**
   * Defaults to 1.0.
...
export declare interface CreateFromBufferOptions {
  /**
...
export declare interface CreateInterruptedDownloadOptions {
  /**
...
export declare interface DefaultFontFamily {
  /**
...
export declare interface DevicePermissionHandlerHandlerDetails {
  /**
   * The export declare type of device that permission is being requested on, can be `hid`,
   * `serial`, or `usb`.
   */
...
export declare interface DevtoolsOpenUrlEvent extends DOMEvent {
  /**
   * URL of the link that was clicked or selected.
   */
  url: string;
...
export declare interface DidChangeThemeColorEvent extends DOMEvent {
  themeColor: string;
}

export declare interface DidCreateWindowDetails {
  /**
...
export declare interface DidFailLoadEvent extends DOMEvent {
  errorCode: number;
  errorDescription: string;
  validatedURL: string;
  isMainFrame: boolean;
...
export declare interface DidFrameFinishLoadEvent extends DOMEvent {
  isMainFrame: boolean;
}

export declare interface DidFrameNavigateEvent extends DOMEvent {
  url: string;
  /**
   * -1 for non HTTP navigations
   */
...
export declare interface DidNavigateEvent extends DOMEvent {
  url: string;
}

export declare interface DidNavigateInPageEvent extends DOMEvent {
  isMainFrame: boolean;
  url: string;
}

export declare interface DidRedirectNavigationEvent extends DOMEvent {
  url: string;
  isInPlace: boolean;
  isMainFrame: boolean;
  frameProcessId: number;
...
export declare interface DidStartNavigationEvent extends DOMEvent {
  url: string;
  isInPlace: boolean;
  isMainFrame: boolean;
  frameProcessId: number;
...
export declare interface DisplayBalloonOptions {
  /**
...
export declare interface DisplayMediaRequestHandlerHandlerRequest {
  /**
...
export declare interface DownloadURLOptions {
  /**
...
export declare interface EnableNetworkEmulationOptions {
  /**
...
export declare interface FeedURLOptions {
  url: string;
  /**
   * HTTP request headers.
   *
...
export declare interface FileIconOptions {
  size: ('small' | 'normal' | 'large');
}

export declare interface FindInPageOptions {
  /**
...
export declare interface ForkOptions {
  /**
...
export declare interface FoundInPageEvent extends DOMEvent {
  result: FoundInPageResult;
}

export declare interface FrameCreatedDetails {
  frame: WebFrameMain;
}

export declare interface FromPartitionOptions {
  /**
...
export declare interface FromPathOptions {
  /**
   * Whether to enable cache.
   */
  cache: boolean;
...
export declare interface HandlerDetails {
  /**
...
export declare interface HeadersReceivedResponse {
  cancel?: boolean;
  /**
...
export declare interface HeapStatistics {
...
export declare interface HidDeviceAddedDetails {
  device: HIDDevice;
  frame: WebFrameMain;
}

export declare interface HidDeviceRemovedDetails {
  device: HIDDevice;
  frame: WebFrameMain;
}

export declare interface HidDeviceRevokedDetails {
  device: HIDDevice;
  /**
...
export declare interface IgnoreMouseEventsOptions {
  /**
...
export declare interface ImportCertificateOptions {
  /**
...
export declare interface InsertCSSOptions {
  /**
...
export declare interface IpcMessageEvent extends DOMEvent {
  /**
...
export declare interface JumpListSettings {
  /**
...
export declare interface LoadCommitEvent extends DOMEvent {
  url: string;
  isMainFrame: boolean;
}

export declare interface LoadExtensionOptions {
  /**
   * Whether to allow the extension to read local files over `file:
   * inject content scripts into `file:
   * devtools extensions on `file:
   */
  allowFileAccess: boolean;
}

export declare interface LoadFileOptions {
  /**
...
export declare interface LoadURLOptions {
  /**
...
export declare interface LoginItemSettings {
  /**
...
export declare interface LoginItemSettingsOptions {
  /**
...
export declare interface MenuItemConstructorOptions {
  /**
  ...
  visible?: boolean;
  /**
   * Should only be specified for `checkbox` or `radio` export declare type menu items.
   */
  checked?: boolean;
  /**
  ...
  sharingItem?: SharingItem;
  /**
   * Should be specified for `submenu` export declare type menu items. If `submenu` is specified,
  ...
  after?: string[];
  /**
   * Provides a means for a single context menu to export declare the placement of their
...
export declare interface MessageBoxSyncOptions {
  /**
   * Content of the message box.
   */
  message: string;
...
export declare interface MessageDetails {
  ...
  versionId: number;
  /**
   * The export declare type of source for this message.  Can be `javascript`, `xml`, `network`,
...
export declare interface MoveToApplicationsFolderOptions {
  /**
...
export declare interface NotificationConstructorOptions {
  /**
...
export declare interface OnBeforeRedirectListenerDetails {
  id: number;
  url: string;
  method: string;
...
export declare interface OnBeforeRequestListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnBeforeSendHeadersListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnCompletedListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnErrorOccurredListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnHeadersReceivedListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnResponseStartedListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OnSendHeadersListenerDetails {
  id: number;
  url: string;
  method: string;
  webContentsId?: number;
...
export declare interface OpenDevToolsOptions {
  /**
...
export declare interface OpenDialogReturnValue {
  /**
...
export declare interface OpenDialogSyncOptions {
  title?: string;
  defaultPath?: string;
  /**
   * Custom label for the confirmation button, when left empty the default label will
...
export declare interface OpenExternalOptions {
  /**
...
export declare interface PageFaviconUpdatedEvent extends DOMEvent {
  /**
   * Array of URLs.
   */
  favicons: string[];
...
export declare interface PageTitleUpdatedEvent extends DOMEvent {
  title: string;
  explicitSet: boolean;
}
...
export declare interface Parameters {
  /**
   * Specify the screen export declare type to emulate (default: `desktop`):
   */
...
export declare interface PermissionCheckHandlerHandlerDetails {
  /**
  ...
  securityOrigin?: string;
  /**
   * The export declare type of media access being requested, can be `video`, `audio` or `unknown`
   */
...
export declare interface PermissionRequestHandlerHandlerDetails {
  /**
...
export declare interface PluginCrashedEvent extends DOMEvent {
  name: string;
  version: string;
}
...
export declare interface PopupOptions {
  ...
  /**
   * Default is the current mouse cursor position. Must be export declared if `y` is
   * export declared.
   */
  x?: number;
  /**
   * Default is the current mouse cursor position. Must be export declared if `x` is
   * export declared.
   */
  y?: number;
  /**
...
export declare interface PreconnectOptions {
  /**
...
export declare interface PrintToPDFOptions {
  /**
...
export declare interface Privileges {
  /**
   * Default false.
   */
  standard?: boolean;
...
export declare interface PurchaseProductOpts {
  /**
...
export declare interface ReadBookmark {
  title: string;
  url: string;
}

export declare interface RegistrationCompletedDetails {
  /**
...
export declare interface RelaunchOptions {
  args?: string[];
  execPath?: string;
}

export declare interface RenderProcessGoneEvent extends DOMEvent {
...
export declare interface ResolveHostOptions {
  /**
...
export declare interface SaveDialogReturnValue {
  /**
   * whether or not the dialog was canceled.
   */
  canceled: boolean;
...
export declare interface SaveDialogSyncOptions {
  /**
   * The dialog title. Cannot be displayed on some _Linux_ desktop environments.
   */
  title?: string;
...
export declare interface SelectHidDeviceDetails {
  deviceList: HIDDevice[];
  frame: WebFrameMain;
}

export declare interface SelectUsbDeviceDetails {
  deviceList: USBDevice[];
  frame: WebFrameMain;
}

export declare interface SerialPortRevokedDetails {
  port: SerialPort;
  frame: WebFrameMain;
  /**
   * The origin that the device has been revoked from.
...
export declare interface SourcesOptions {
  /**
...
export declare interface SSLConfigConfig {
  /**
...
export declare interface StartLoggingOptions {
  /**
...
export declare interface SystemMemoryInfo {
  /**
...
export declare interface TitleBarOverlay {
  /**
...
export declare interface TitleBarOverlayOptions {
  /**
...
export declare interface TitleOptions {
  /**
...
export declare interface ToBitmapOptions {
  /**
   * Defaults to 1.0.
   */
  scaleFactor?: number;
...
export declare interface ToPNGOptions {
  /**
   * Defaults to 1.0.
   */
  scaleFactor?: number;
...
export declare interface TouchBarButtonConstructorOptions {
  /**
   * Button text.
   */
  label?: string;
...
export declare interface TouchBarColorPickerConstructorOptions {
  /**
...
export declare interface TouchBarConstructorOptions {
...
export declare interface TouchBarGroupConstructorOptions {
  /**
...
export declare interface TouchBarLabelConstructorOptions {
  /**
   * Text to display.
   */
  label?: string;
...
export declare interface TouchBarPopoverConstructorOptions {
  /**
   * Popover button text.
   */
  label?: string;
...
export declare interface TouchBarScrubberConstructorOptions {
  /**
...
export declare interface TouchBarSegmentedControlConstructorOptions {
  /**
...
export declare interface TouchBarSliderConstructorOptions {
  /**
   * Label text.
   */
  label?: string;
...
export declare interface TouchBarSpacerConstructorOptions {
  /**
...
export declare interface TraceBufferUsageReturnValue {
  value: number;
  percentage: number;
}

export declare interface UdpPortRange {
  /**
...
export declare interface UpdateTargetUrlEvent extends DOMEvent {
  url: string;
}
...
export declare interface UsbDeviceRevokedDetails {
  device: USBDevice;
  /**
   * The origin that the device has been revoked from.
   */
...
export declare interface USBProtectedClassesHandlerHandlerDetails {
  /**
...
export declare interface VisibleOnAllWorkspacesOptions {
  /**
   ...
   * time it is called. If your window is already of export declare type UIElementApplication, you
...
export declare interface WebContentsAudioStateChangedEventParams {
  /**
...
export declare interface WebContentsDidRedirectNavigationEventParams {
  /**
...
export declare interface WebContentsDidStartNavigationEventParams {
  /**
   * The URL the frame is navigating to.
   */
  url: string;
...
export declare interface WebContentsPrintOptions {
  /**
...
export declare interface WebContentsWillFrameNavigateEventParams {
  /**
   * The URL the frame is navigating to.
   */
  url: string;
...
export declare interface WebContentsWillNavigateEventParams {
  /**
   * The URL the frame is navigating to.
   */
  url: string;
...
export declare interface WebContentsWillRedirectEventParams {
  /**
   * The URL the frame is navigating to.
   */
  url: string;
...
export declare interface WebRTCUDPPortRange {
  /**
   * The minimum UDP port number that WebRTC should use.
   */
  min: number;
...
export declare interface WebviewTagPrintOptions {
  /**
   * Don't ask user for print settings. Default is `false`.
   */
  silent?: boolean;
...
export declare interface WillFrameNavigateEvent extends DOMEvent {
  url: string;
  isMainFrame: boolean;
  frameProcessId: number;
  frameRoutingId: number;
...
export declare interface WillNavigateEvent extends DOMEvent {
  url: string;
}

export declare interface WillResizeDetails {
  /**
...
export declare interface EditFlags {
  /**
...
export declare interface FoundInPageResult {
  requestId: number;
  /**
   * Position of the active match.
   */
...
export declare interface LaunchItems {
  /**
...
export declare interface MediaFlags {
  /**
...
export declare interface PageRanges {
  /**
...
export declare interface RemoteMainInterface {
  app: App;
...
export declare namespace Common {
  export declare type Event<Params extends object = {}> = Electron.Event<Params>;
  export declare const clipboard: Clipboard;
  export declare type Clipboard = Electron.Clipboard;
  export declare const crashReporter: CrashReporter;
  export declare type CrashReporter = Electron.CrashReporter;
  export declare const nativeImage: typeof NativeImage;
  export declare type NativeImage = Electron.NativeImage;
  export declare const shell: Shell;
  export declare type Shell = Electron.Shell;
  export declare type AboutPanelOptionsOptions = Electron.AboutPanelOptionsOptions;
  export declare type AddRepresentationOptions = Electron.AddRepresentationOptions;
  export declare type AdjustSelectionOptions = Electron.AdjustSelectionOptions;
  export declare type AnimationSettings = Electron.AnimationSettings;
  export declare type AppDetailsOptions = Electron.AppDetailsOptions;
  export declare type ApplicationInfoForProtocolReturnValue = Electron.ApplicationInfoForProtocolReturnValue;
  export declare type AuthenticationResponseDetails = Electron.AuthenticationResponseDetails;
  export declare type AuthInfo = Electron.AuthInfo;
  export declare type AutoResizeOptions = Electron.AutoResizeOptions;
  export declare type BeforeSendResponse = Electron.BeforeSendResponse;
  export declare type BitmapOptions = Electron.BitmapOptions;
  export declare type BlinkMemoryInfo = Electron.BlinkMemoryInfo;
  export declare type BluetoothPairingHandlerHandlerDetails = Electron.BluetoothPairingHandlerHandlerDetails;
  export declare type BrowserViewConstructorOptions = Electron.BrowserViewConstructorOptions;
  export declare type CallbackResponse = Electron.CallbackResponse;
  export declare type CertificateTrustDialogOptions = Electron.CertificateTrustDialogOptions;
  export declare type ClearCodeCachesOptions = Electron.ClearCodeCachesOptions;
  export declare type ClearStorageDataOptions = Electron.ClearStorageDataOptions;
  export declare type ClientRequestConstructorOptions = Electron.ClientRequestConstructorOptions;
  export declare type CloseOpts = Electron.CloseOpts;
  export declare type Config = Electron.Config;
  export declare type ConfigureHostResolverOptions = Electron.ConfigureHostResolverOptions;
  export declare type ConsoleMessageEvent = Electron.ConsoleMessageEvent;
  export declare type ContextMenuEvent = Electron.ContextMenuEvent;
  export declare type ContextMenuParams = Electron.ContextMenuParams;
  export declare type ContinueActivityDetails = Electron.ContinueActivityDetails;
  export declare type CookiesGetFilter = Electron.CookiesGetFilter;
  export declare type CookiesSetDetails = Electron.CookiesSetDetails;
  export declare type CrashReporterStartOptions = Electron.CrashReporterStartOptions;
  export declare type CreateFromBitmapOptions = Electron.CreateFromBitmapOptions;
  export declare type CreateFromBufferOptions = Electron.CreateFromBufferOptions;
  export declare type CreateInterruptedDownloadOptions = Electron.CreateInterruptedDownloadOptions;
  export declare type Data = Electron.Data;
  export declare type DefaultFontFamily = Electron.DefaultFontFamily;
  export declare type Details = Electron.Details;
  export declare type DevicePermissionHandlerHandlerDetails = Electron.DevicePermissionHandlerHandlerDetails;
  export declare type DevtoolsOpenUrlEvent = Electron.DevtoolsOpenUrlEvent;
  export declare type DidChangeThemeColorEvent = Electron.DidChangeThemeColorEvent;
  export declare type DidCreateWindowDetails = Electron.DidCreateWindowDetails;
  export declare type DidFailLoadEvent = Electron.DidFailLoadEvent;
  export declare type DidFrameFinishLoadEvent = Electron.DidFrameFinishLoadEvent;
  export declare type DidFrameNavigateEvent = Electron.DidFrameNavigateEvent;
  export declare type DidNavigateEvent = Electron.DidNavigateEvent;
  export declare type DidNavigateInPageEvent = Electron.DidNavigateInPageEvent;
  export declare type DidRedirectNavigationEvent = Electron.DidRedirectNavigationEvent;
  export declare type DidStartNavigationEvent = Electron.DidStartNavigationEvent;
  export declare type DisplayBalloonOptions = Electron.DisplayBalloonOptions;
  export declare type DisplayMediaRequestHandlerHandlerRequest = Electron.DisplayMediaRequestHandlerHandlerRequest;
  export declare type DownloadURLOptions = Electron.DownloadURLOptions;
  export declare type EnableNetworkEmulationOptions = Electron.EnableNetworkEmulationOptions;
  export declare type FeedURLOptions = Electron.FeedURLOptions;
  export declare type FileIconOptions = Electron.FileIconOptions;
  export declare type FindInPageOptions = Electron.FindInPageOptions;
  export declare type FocusOptions = Electron.FocusOptions;
  export declare type ForkOptions = Electron.ForkOptions;
  export declare type FoundInPageEvent = Electron.FoundInPageEvent;
  export declare type FrameCreatedDetails = Electron.FrameCreatedDetails;
  export declare type FromPartitionOptions = Electron.FromPartitionOptions;
  export declare type FromPathOptions = Electron.FromPathOptions;
  export declare type HandlerDetails = Electron.HandlerDetails;
  export declare type HeadersReceivedResponse = Electron.HeadersReceivedResponse;
  export declare type HeapStatistics = Electron.HeapStatistics;
  export declare type HidDeviceAddedDetails = Electron.HidDeviceAddedDetails;
  export declare type HidDeviceRemovedDetails = Electron.HidDeviceRemovedDetails;
  export declare type HidDeviceRevokedDetails = Electron.HidDeviceRevokedDetails;
  export declare type IgnoreMouseEventsOptions = Electron.IgnoreMouseEventsOptions;
  export declare type ImportCertificateOptions = Electron.ImportCertificateOptions;
  export declare type Info = Electron.Info;
  export declare type Input = Electron.Input;
  export declare type InsertCSSOptions = Electron.InsertCSSOptions;
  export declare type IpcMessageEvent = Electron.IpcMessageEvent;
  export declare type Item = Electron.Item;
  export declare type JumpListSettings = Electron.JumpListSettings;
  export declare type LoadCommitEvent = Electron.LoadCommitEvent;
  export declare type LoadExtensionOptions = Electron.LoadExtensionOptions;
  export declare type LoadFileOptions = Electron.LoadFileOptions;
  export declare type LoadURLOptions = Electron.LoadURLOptions;
  export declare type LoginItemSettings = Electron.LoginItemSettings;
  export declare type LoginItemSettingsOptions = Electron.LoginItemSettingsOptions;
  export declare type MenuItemConstructorOptions = Electron.MenuItemConstructorOptions;
  export declare type MessageBoxOptions = Electron.MessageBoxOptions;
  export declare type MessageBoxReturnValue = Electron.MessageBoxReturnValue;
  export declare type MessageBoxSyncOptions = Electron.MessageBoxSyncOptions;
  export declare type MessageDetails = Electron.MessageDetails;
  export declare type MessageEvent = Electron.MessageEvent;
  export declare type MoveToApplicationsFolderOptions = Electron.MoveToApplicationsFolderOptions;
  export declare type NotificationConstructorOptions = Electron.NotificationConstructorOptions;
  export declare type OnBeforeRedirectListenerDetails = Electron.OnBeforeRedirectListenerDetails;
  export declare type OnBeforeRequestListenerDetails = Electron.OnBeforeRequestListenerDetails;
  export declare type OnBeforeSendHeadersListenerDetails = Electron.OnBeforeSendHeadersListenerDetails;
  export declare type OnCompletedListenerDetails = Electron.OnCompletedListenerDetails;
  export declare type OnErrorOccurredListenerDetails = Electron.OnErrorOccurredListenerDetails;
  export declare type OnHeadersReceivedListenerDetails = Electron.OnHeadersReceivedListenerDetails;
  export declare type OnResponseStartedListenerDetails = Electron.OnResponseStartedListenerDetails;
  export declare type OnSendHeadersListenerDetails = Electron.OnSendHeadersListenerDetails;
  export declare type OpenDevToolsOptions = Electron.OpenDevToolsOptions;
  export declare type OpenDialogOptions = Electron.OpenDialogOptions;
  export declare type OpenDialogReturnValue = Electron.OpenDialogReturnValue;
  export declare type OpenDialogSyncOptions = Electron.OpenDialogSyncOptions;
  export declare type OpenExternalOptions = Electron.OpenExternalOptions;
  export declare type Options = Electron.Options;
  export declare type Opts = Electron.Opts;
  export declare type PageFaviconUpdatedEvent = Electron.PageFaviconUpdatedEvent;
  export declare type PageTitleUpdatedEvent = Electron.PageTitleUpdatedEvent;
  export declare type Parameters = Electron.Parameters;
  export declare type Payment = Electron.Payment;
  export declare type PermissionCheckHandlerHandlerDetails = Electron.PermissionCheckHandlerHandlerDetails;
  export declare type PermissionRequestHandlerHandlerDetails = Electron.PermissionRequestHandlerHandlerDetails;
  export declare type PluginCrashedEvent = Electron.PluginCrashedEvent;
  export declare type PopupOptions = Electron.PopupOptions;
  export declare type PreconnectOptions = Electron.PreconnectOptions;
  export declare type PrintToPDFOptions = Electron.PrintToPDFOptions;
  export declare type Privileges = Electron.Privileges;
  export declare type ProgressBarOptions = Electron.ProgressBarOptions;
  export declare type Provider = Electron.Provider;
  export declare type PurchaseProductOpts = Electron.PurchaseProductOpts;
  export declare type ReadBookmark = Electron.ReadBookmark;
  export declare type RegistrationCompletedDetails = Electron.RegistrationCompletedDetails;
  export declare type RelaunchOptions = Electron.RelaunchOptions;
  export declare type RenderProcessGoneEvent = Electron.RenderProcessGoneEvent;
  export declare type Request = Electron.Request;
  export declare type ResizeOptions = Electron.ResizeOptions;
  export declare type ResolveHostOptions = Electron.ResolveHostOptions;
  export declare type ResourceUsage = Electron.ResourceUsage;
  export declare type Response = Electron.Response;
  export declare type Result = Electron.Result;
  export declare type SaveDialogOptions = Electron.SaveDialogOptions;
  export declare type SaveDialogReturnValue = Electron.SaveDialogReturnValue;
  export declare type SaveDialogSyncOptions = Electron.SaveDialogSyncOptions;
  export declare type SelectHidDeviceDetails = Electron.SelectHidDeviceDetails;
  export declare type SelectUsbDeviceDetails = Electron.SelectUsbDeviceDetails;
  export declare type SerialPortRevokedDetails = Electron.SerialPortRevokedDetails;
  export declare type Settings = Electron.Settings;
  export declare type SourcesOptions = Electron.SourcesOptions;
  export declare type SSLConfigConfig = Electron.SSLConfigConfig;
  export declare type StartLoggingOptions = Electron.StartLoggingOptions;
  export declare type Streams = Electron.Streams;
  export declare type SystemMemoryInfo = Electron.SystemMemoryInfo;
  export declare type TitleBarOverlay = Electron.TitleBarOverlay;
  export declare type TitleBarOverlayOptions = Electron.TitleBarOverlayOptions;
  export declare type TitleOptions = Electron.TitleOptions;
  export declare type ToBitmapOptions = Electron.ToBitmapOptions;
  export declare type ToDataURLOptions = Electron.ToDataURLOptions;
  export declare type ToPNGOptions = Electron.ToPNGOptions;
  export declare type TouchBarButtonConstructorOptions = Electron.TouchBarButtonConstructorOptions;
  export declare type TouchBarColorPickerConstructorOptions = Electron.TouchBarColorPickerConstructorOptions;
  export declare type TouchBarConstructorOptions = Electron.TouchBarConstructorOptions;
  export declare type TouchBarGroupConstructorOptions = Electron.TouchBarGroupConstructorOptions;
  export declare type TouchBarLabelConstructorOptions = Electron.TouchBarLabelConstructorOptions;
  export declare type TouchBarPopoverConstructorOptions = Electron.TouchBarPopoverConstructorOptions;
  export declare type TouchBarScrubberConstructorOptions = Electron.TouchBarScrubberConstructorOptions;
  export declare type TouchBarSegmentedControlConstructorOptions = Electron.TouchBarSegmentedControlConstructorOptions;
  export declare type TouchBarSliderConstructorOptions = Electron.TouchBarSliderConstructorOptions;
  export declare type TouchBarSpacerConstructorOptions = Electron.TouchBarSpacerConstructorOptions;
  export declare type TraceBufferUsageReturnValue = Electron.TraceBufferUsageReturnValue;
  export declare type UdpPortRange = Electron.UdpPortRange;
  export declare type UpdateTargetUrlEvent = Electron.UpdateTargetUrlEvent;
  export declare type UploadProgress = Electron.UploadProgress;
  export declare type UsbDeviceRevokedDetails = Electron.UsbDeviceRevokedDetails;
  export declare type USBProtectedClassesHandlerHandlerDetails = Electron.USBProtectedClassesHandlerHandlerDetails;
  export declare type VisibleOnAllWorkspacesOptions = Electron.VisibleOnAllWorkspacesOptions;
  export declare type WebContentsAudioStateChangedEventParams = Electron.WebContentsAudioStateChangedEventParams;
  export declare type WebContentsDidRedirectNavigationEventParams = Electron.WebContentsDidRedirectNavigationEventParams;
  export declare type WebContentsDidStartNavigationEventParams = Electron.WebContentsDidStartNavigationEventParams;
  export declare type WebContentsPrintOptions = Electron.WebContentsPrintOptions;
  export declare type WebContentsWillFrameNavigateEventParams = Electron.WebContentsWillFrameNavigateEventParams;
  export declare type WebContentsWillNavigateEventParams = Electron.WebContentsWillNavigateEventParams;
  export declare type WebContentsWillRedirectEventParams = Electron.WebContentsWillRedirectEventParams;
  export declare type WebRTCUDPPortRange = Electron.WebRTCUDPPortRange;
  export declare type WebviewTagPrintOptions = Electron.WebviewTagPrintOptions;
  export declare type WillFrameNavigateEvent = Electron.WillFrameNavigateEvent;
  export declare type WillNavigateEvent = Electron.WillNavigateEvent;
  export declare type WillResizeDetails = Electron.WillResizeDetails;
  export declare type EditFlags = Electron.EditFlags;
  export declare type Env = Electron.Env;
  export declare type FoundInPageResult = Electron.FoundInPageResult;
  export declare type LaunchItems = Electron.LaunchItems;
  export declare type Margins = Electron.Margins;
  export declare type MediaFlags = Electron.MediaFlags;
  export declare type PageRanges = Electron.PageRanges;
  export declare type Params = Electron.Params;
  export declare type Video = Electron.Video;
  export declare type BluetoothDevice = Electron.BluetoothDevice;
  export declare type BrowserWindowConstructorOptions = Electron.BrowserWindowConstructorOptions;
  export declare type Certificate = Electron.Certificate;
  export declare type CertificatePrincipal = Electron.CertificatePrincipal;
  export declare type Cookie = Electron.Cookie;
  export declare type CPUUsage = Electron.CPUUsage;
  export declare type CrashReport = Electron.CrashReport;
  export declare type CustomScheme = Electron.CustomScheme;
  export declare type DesktopCapturerSource = Electron.DesktopCapturerSource;
  export declare type Display = Electron.Display;
  export declare type Extension = Electron.Extension;
  export declare type ExtensionInfo = Electron.ExtensionInfo;
  export declare type FileFilter = Electron.FileFilter;
  export declare type FilePathWithHeaders = Electron.FilePathWithHeaders;
  export declare type GPUFeatureStatus = Electron.GPUFeatureStatus;
  export declare type HIDDevice = Electron.HIDDevice;
  export declare type InputEvent = Electron.InputEvent;
  export declare type IOCounters = Electron.IOCounters;
  export declare type IpcMainEvent = Electron.IpcMainEvent;
  export declare type IpcMainInvokeEvent = Electron.IpcMainInvokeEvent;
  export declare type IpcRendererEvent = Electron.IpcRendererEvent;
  export declare type JumpListCategory = Electron.JumpListCategory;
  export declare type JumpListItem = Electron.JumpListItem;
  export declare type KeyboardEvent = Electron.KeyboardEvent;
  export declare type KeyboardInputEvent = Electron.KeyboardInputEvent;
  export declare type MemoryInfo = Electron.MemoryInfo;
  export declare type MemoryUsageDetails = Electron.MemoryUsageDetails;
  export declare type MimeTypedBuffer = Electron.MimeTypedBuffer;
  export declare type MouseInputEvent = Electron.MouseInputEvent;
  export declare type MouseWheelInputEvent = Electron.MouseWheelInputEvent;
  export declare type NotificationAction = Electron.NotificationAction;
  export declare type NotificationResponse = Electron.NotificationResponse;
  export declare type PaymentDiscount = Electron.PaymentDiscount;
  export declare type Point = Electron.Point;
  export declare type PostBody = Electron.PostBody;
  export declare type PrinterInfo = Electron.PrinterInfo;
  export declare type ProcessMemoryInfo = Electron.ProcessMemoryInfo;
  export declare type ProcessMetric = Electron.ProcessMetric;
  export declare type Product = Electron.Product;
  export declare type ProductDiscount = Electron.ProductDiscount;
  export declare type ProductSubscriptionPeriod = Electron.ProductSubscriptionPeriod;
  export declare type ProtocolRequest = Electron.ProtocolRequest;
  export declare type ProtocolResponse = Electron.ProtocolResponse;
  export declare type ProtocolResponseUploadData = Electron.ProtocolResponseUploadData;
  export declare type Rectangle = Electron.Rectangle;
  export declare type Referrer = Electron.Referrer;
  export declare type RenderProcessGoneDetails = Electron.RenderProcessGoneDetails;
  export declare type ResolvedEndpoint = Electron.ResolvedEndpoint;
  export declare type ResolvedHost = Electron.ResolvedHost;
  export declare type ScrubberItem = Electron.ScrubberItem;
  export declare type SegmentedControlSegment = Electron.SegmentedControlSegment;
  export declare type SerialPort = Electron.SerialPort;
  export declare type ServiceWorkerInfo = Electron.ServiceWorkerInfo;
  export declare type SharedWorkerInfo = Electron.SharedWorkerInfo;
  export declare type SharingItem = Electron.SharingItem;
  export declare type ShortcutDetails = Electron.ShortcutDetails;
  export declare type Size = Electron.Size;
  export declare type Task = Electron.Task;
  export declare type ThumbarButton = Electron.ThumbarButton;
  export declare type TraceCategoriesAndOptions = Electron.TraceCategoriesAndOptions;
  export declare type TraceConfig = Electron.TraceConfig;
  export declare type Transaction = Electron.Transaction;
  export declare type UploadData = Electron.UploadData;
  export declare type UploadFile = Electron.UploadFile;
  export declare type UploadRawData = Electron.UploadRawData;
  export declare type USBDevice = Electron.USBDevice;
  export declare type UserDefaultTypes = Electron.UserDefaultTypes;
  export declare type WebPreferences = Electron.WebPreferences;
  export declare type WebRequestFilter = Electron.WebRequestFilter;
  export declare type WebSource = Electron.WebSource;
}

export declare namespace Main {
  export declare type Event<Params extends object = {}> = Electron.Event<Params>;
  export declare const app: App;
  export declare type App = Electron.App;
  export declare const autoUpdater: AutoUpdater;
  export declare type AutoUpdater = Electron.AutoUpdater;
  class BrowserView extends Electron.BrowserView { }
  class BrowserWindow extends Electron.BrowserWindow { }
  export declare type ClientRequest = Electron.ClientRequest;
  export declare type CommandLine = Electron.CommandLine;
  export declare const contentTracing: ContentTracing;
  export declare type ContentTracing = Electron.ContentTracing;
  export declare type Cookies = Electron.Cookies;
  export declare type Debugger = Electron.Debugger;
  export declare const desktopCapturer: DesktopCapturer;
  export declare type DesktopCapturer = Electron.DesktopCapturer;
  export declare const dialog: Dialog;
  export declare type Dialog = Electron.Dialog;
  export declare type Dock = Electron.Dock;
  export declare type DownloadItem = Electron.DownloadItem;
  export declare const globalShortcut: GlobalShortcut;
  export declare type GlobalShortcut = Electron.GlobalShortcut;
  export declare const inAppPurchase: InAppPurchase;
  export declare type InAppPurchase = Electron.InAppPurchase;
  export declare type IncomingMessage = Electron.IncomingMessage;
  export declare const ipcMain: IpcMain;
  export declare type IpcMain = Electron.IpcMain;
  ...
  export declare type MessagePortMain = Electron.MessagePortMain;
  export declare const nativeTheme: NativeTheme;
  export declare type NativeTheme = Electron.NativeTheme;
  export declare const net: Net;
  export declare type Net = Electron.Net;
  export declare const netLog: NetLog;
  export declare type NetLog = Electron.NetLog;
  class Notification extends Electron.Notification { }
  export declare const powerMonitor: PowerMonitor;
  export declare type PowerMonitor = Electron.PowerMonitor;
  export declare const powerSaveBlocker: PowerSaveBlocker;
  export declare type PowerSaveBlocker = Electron.PowerSaveBlocker;
  export declare const protocol: Protocol;
  export declare type Protocol = Electron.Protocol;
  export declare const pushNotifications: PushNotifications;
  export declare type PushNotifications = Electron.PushNotifications;
  export declare const safeStorage: SafeStorage;
  export declare type SafeStorage = Electron.SafeStorage;
  export declare const screen: Screen;
  export declare type Screen = Electron.Screen;
  export declare type ServiceWorkers = Electron.ServiceWorkers;
  export declare const session: typeof Session;
  export declare type Session = Electron.Session;
  class ShareMenu extends Electron.ShareMenu { }
  export declare const systemPreferences: SystemPreferences;
  export declare type SystemPreferences = Electron.SystemPreferences;
  class TouchBar extends Electron.TouchBar { }
  export declare type TouchBarButton = Electron.TouchBarButton;
  export declare type TouchBarColorPicker = Electron.TouchBarColorPicker;
  export declare type TouchBarGroup = Electron.TouchBarGroup;
  export declare type TouchBarLabel = Electron.TouchBarLabel;
  export declare type TouchBarOtherItemsProxy = Electron.TouchBarOtherItemsProxy;
  export declare type TouchBarPopover = Electron.TouchBarPopover;
  export declare type TouchBarScrubber = Electron.TouchBarScrubber;
  export declare type TouchBarSegmentedControl = Electron.TouchBarSegmentedControl;
  export declare type TouchBarSlider = Electron.TouchBarSlider;
  export declare type TouchBarSpacer = Electron.TouchBarSpacer;
  class Tray extends Electron.Tray { }
  export declare const utilityProcess: typeof UtilityProcess;
  export declare type UtilityProcess = Electron.UtilityProcess;
  export declare const webContents: typeof WebContents;
  export declare type WebContents = Electron.WebContents;
  export declare const webFrameMain: typeof WebFrameMain;
  export declare type WebFrameMain = Electron.WebFrameMain;
  export declare type WebRequest = Electron.WebRequest;
  export declare type AboutPanelOptionsOptions = Electron.AboutPanelOptionsOptions;
  export declare type AddRepresentationOptions = Electron.AddRepresentationOptions;
  export declare type AdjustSelectionOptions = Electron.AdjustSelectionOptions;
  export declare type AnimationSettings = Electron.AnimationSettings;
...
export declare namespace Renderer {
  ...
  export declare type ContextBridge = Electron.ContextBridge;
  export declare const ipcRenderer: IpcRenderer;
  export declare type IpcRenderer = Electron.IpcRenderer;
  export declare const webFrame: WebFrame;
  export declare type WebFrame = Electron.WebFrame;
  export declare type WebviewTag = Electron.WebviewTag;
  export declare type AboutPanelOptionsOptions = Electron.AboutPanelOptionsOptions;
  export declare type AddRepresentationOptions = Electron.AddRepresentationOptions;
  export declare type AdjustSelectionOptions = Electron.AdjustSelectionOptions;
  export declare type AnimationSettings = Electron.AnimationSettings;
...
export declare namespace CrossProcessExports {
  export declare type Event<Params extends object = {}> = Electron.Event<Params>;
  export declare const app: App;
  export declare type App = Electron.App;
  export declare const autoUpdater: AutoUpdater;
...
export declare const net: Net;
export declare const netLog: NetLog;
export declare const parentPort: ParentPort;
export declare const powerMonitor: PowerMonitor;
export declare const powerSaveBlocker: PowerSaveBlocker;
export declare const protocol: Protocol;
export declare const pushNotifications: PushNotifications;
...
export declare module 'electron' {
  export = Electron.CrossProcessExports;
}

export declare module 'electron/main' {
  export = Electron.Main;
}

export declare module 'electron/common' {
  export = Electron.Common;
}

export declare module 'electron/renderer' {
  export = Electron.Renderer;
}

export declare interface NodeRequireFunction {
...
export declare interface NodeRequire {
  (moduleName: 'electron'): typeof Electron.CrossProcessExports;
  (moduleName: 'electron/main'): typeof Electron.Main;
  (moduleName: 'electron/common'): typeof Electron.Common;
  (moduleName: 'electron/renderer'): typeof Electron.Renderer;
...
export declare module 'original-fs' {
  import * as fs from 'fs';
  export = fs;
}

export declare module 'node:original-fs' {
  import * as fs from 'fs';
  export = fs;
}
...
export declare namespace NodeJS {
  export declare interface Process extends NodeJS.EventEmitter {
  ...
  export declare interface ProcessVersions {
    readonly electron: string;
    readonly chrome: string;
  }
}